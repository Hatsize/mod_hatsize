...
require_once($CFG->dirroot . '/mod/hatsize/backup/moodle2/backup_hatsize_stepslib.php');

/**
 * Provides all the settings and steps to perform one complete backup of the activity
 */
class backup_hatsize_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the hatsize.xml file
     */
    protected function define_my_steps() {
        $this->add_step(new backup_hatsize_activity_structure_step('hatsize_structure', 'hatsize.xml'));
    }
